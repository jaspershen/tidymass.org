...
remotes::install_gitlab("tidymass/massdataset", dependencies = TRUE)
remotes::install_gitlab("tidymass/massqc", dependencies = TRUE)
remotes::install_gitlab("tidymass/massprocesser", dependencies = TRUE)
remotes::install_gitlab("tidymass/masscleaner", dependencies = TRUE)
...
```r
remotes::install_git(url = "https://gitee.com/tidymass/masstools", dependencies = TRUE)
remotes::install_git(url = "https://gitee.com/tidymass/massdataset", dependencies = TRUE)
remotes::install_git(url = "https://gitee.com/tidymass/massqc", dependencies = TRUE)
remotes::install_git(url = "https://gitee.com/tidymass/massprocesser", dependencies = TRUE)
remotes::install_git(url = "https://gitee.com/tidymass/masscleaner", dependencies = TRUE)
remotes::install_git(url = "https://gitee.com/tidymass/massstat", dependencies = TRUE)
remotes::install_git(url = "https://gitee.com/tidymass/metid", dependencies = TRUE)
remotes::install_git(url = "https://gitee.com/tidymass/metpath", dependencies = TRUE)
```
